...
function buildConservativeRuleCatalog(entry) {
        ...
        sources: [
            {
                ...
                notes: "Governance readiness source used only to ground a conservative escalation response. It is not statutory legal text.",
                official: true
            }
        ],
        rules: [
            {
                ...
                outcomes: {
                    matched: {
                        ...
                        reason: `${entry.title} is runnable in private beta. The supplied employee count permits the deterministic review to run, but the feature-specific legal rule and statutory source corpus are not yet qualified for a substantive applicability conclusion.`,
                    ...
                    missing: {
                        ...
                        reasonCode: missingReasonCode,
                        reason: `Employee count is required to run the conservative ${entry.title} private-beta review. No missing fact may be inferred from retrieval or model output.`,
                        recommendation: recommendation(
                            `${featureSlug}.confirm-input`,
                            `Confirm the ${entry.title} review input`,
                            "Confirm the organisation's non-negative employee count, then re-run the deterministic private-beta review."
                        )
                    }
                },
