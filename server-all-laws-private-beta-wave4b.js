"use strict";
const base=require("./server-all-laws-private-beta-wave4a.js");
const {ESI_WAVE4B_CATALOG_ID,ESI_WAVE4B_CATALOG_PATH,ESI_WAVE4B_FEATURE_IDS,ESI_WAVE4B_PROFILE_DEFINITIONS}=require("./server-esi-wave4b-rule-catalogs.js");
...
function buildAllLawsPrivateBetaRegistry(options={}){
 ...
 registry.catalogs.push({catalogId:ESI_WAVE4B_CATALOG_ID,lawFamilyId:"esi",catalogPath:ESI_WAVE4B_CATALOG_PATH,format:"governed-legal-source-chunks-v1",runtimeStatus:"available-private-beta",legalReviewStatus:"needs-legal-review",catalogMode:"statutory",allowedFeatureIds:[...ESI_WAVE4B_FEATURE_IDS].sort()});
 registry.catalogs.sort((a,b)=>text(a.catalogId).localeCompare(text(b.catalogId)));
 registry.registryVersion="0.9.0";registry.updatedAt="2026-08-06";
 registry.limitations=[
  ...
  "Wave 4B reviews continuing or voluntary coverage, area commencement, Chapter IV wage-ceiling source, ceiling continuation and contribution-rate source controls without deciding applicability, thresholds, rates, amounts or individual insurance.",
