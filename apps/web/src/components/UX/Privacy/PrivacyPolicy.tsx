...
export function PrivacyPolicy() {
  return (
    <main className="gwhr-privacy">
      <style>{`.gwhr-privacy{max-width:980px;margin:auto;padding:clamp(1rem,4vw,3rem);line-height:1.65;color:#24364b}.gwhr-privacy h1,.gwhr-privacy h2{color:#102033}.gwhr-table{width:100%;border-collapse:collapse;overflow:hidden;border-radius:18px}.gwhr-table th,.gwhr-table td{border:1px solid #dbe7ff;padding:.85rem;text-align:left}.gwhr-table th{background:#eef5ff}@media(max-width:640px){.gwhr-table{display:block;overflow-x:auto}}`}</style>
      <h1>Privacy and data handling for the Executive Assessment</h1>
      <p>We ask for business context so the advisory can be specific. In this client-side version, that information stays in your browser unless you choose to copy it or a future consent-based integration is added.</p>
      <DataHandling />
      <h2>Retention rules</h2>
      <table className="gwhr-table"><thead><tr><th>Data</th><th>Where it lives now</th><th>Retention</th></tr></thead><tbody><tr><td>Assessment answers</td><td>Your browser localStorage</td><td>Until you clear it or the session expires</td></tr><tr><td>Contact fields</td><td>Your browser only</td><td>Until you clear it</td></tr><tr><td>Remote copies</td><td>Not enabled</td><td>Not applicable</td></tr></tbody></table>
      <h2>Commitments</h2>
