...
export function generatePersonalizedReport(data: CompanyAssessmentData): PersonalizedReport {
  ...
  return {
    ...
    privacyNote: 'This report is generated in the browser. No assessment answers are sent to HRTechify in the current client-side build.',
  };
}
