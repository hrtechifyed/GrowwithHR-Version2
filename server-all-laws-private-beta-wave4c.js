"use strict";
const base=require("./server-all-laws-private-beta-wave4b.js");
const {ESI_WAVE4C_CATALOG_ID,ESI_WAVE4C_CATALOG_PATH,ESI_WAVE4C_FEATURE_IDS,ESI_WAVE4C_PROFILE_DEFINITIONS}=require("./server-esi-wave4c-rule-catalogs.js");
...
function buildAllLawsPrivateBetaRegistry(options={}){
 ...
 registry.catalogs.push({catalogId:ESI_WAVE4C_CATALOG_ID,lawFamilyId:"esi",catalogPath:ESI_WAVE4C_CATALOG_PATH,format:"governed-legal-source-chunks-v1",runtimeStatus:"available-private-beta",legalReviewStatus:"needs-legal-review",catalogMode:"statutory",allowedFeatureIds:[...ESI_WAVE4C_FEATURE_IDS].sort()});
 registry.catalogs.sort((a,b)=>text(a.catalogId).localeCompare(text(b.catalogId)));
 registry.registryVersion="0.10.0";registry.updatedAt="2026-08-06";
 registry.limitations=[
  ...
  "Wave 4C reviews special coverage-route controls, benefit-process support controls and medical-administration source routing without classifying coverage, deciding claims, processing medical data or determining individual entitlement.",
