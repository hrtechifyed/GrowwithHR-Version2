   ...
   if (this.onWelcome) {
    ...
    showNameCapture() {
        ...
        this.reviewContainer.innerHTML = [
            ...
            '<input id="recipientName" class="exec-input" type="text" maxlength="80" autocomplete="name" value="' + this.escapeAttribute(this.responses.recipientName || '') + '" required>',
    ...
    showEmailCapture() {
        ...
        this.reviewContainer.innerHTML = [
            ...
            '<input id="recipientEmail" class="exec-input" type="email" autocomplete="email" value="' + this.escapeAttribute(this.responses.recipientEmail || '') + '" required>',
            '<div id="contactValidation" class="exec-validation-message" role="alert" aria-live="polite"></div>',
            '</div>'
        ].join("");
        this.generateButton.disabled = false;
