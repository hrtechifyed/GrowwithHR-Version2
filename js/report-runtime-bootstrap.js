...
(() => {
    ...
    const VERSION = "0.26.3-profile-summary-two-attachment-bootstrap";
    ...
    async function load() {
        ...
        try {
            ...
            if (!visualReady) throw new Error("The profile-tailored report and two-attachment delivery layer did not become ready.");
