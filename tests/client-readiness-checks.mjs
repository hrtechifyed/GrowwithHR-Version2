...
assert(homepage.includes('OUR PRODUCTS') || homepage.includes('Our products'));
assert(homepage.includes('HR Compliance Readiness'));
assert(homepage.includes('Organization Structure &amp; Growth · Flagship'));
assert(homepage.includes('Workforce &amp; Capability Planning'));
assert(homepage.includes('data-testid="home-product-preview"'));
assert(homepage.includes('data-testid="home-report-preview"'));
assert(homepage.includes('No arbitrary scores'));
...
assert(!homepage.includes('dnaCoreCanvas'));
