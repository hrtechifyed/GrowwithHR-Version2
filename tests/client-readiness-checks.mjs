...
assert(homepage.includes('<span class="buyer-card__label">HR Compliance Readiness</span>'));
assert(homepage.includes('<span class="buyer-card__label">Organization &amp; Growth</span>'));
assert(homepage.includes('<span class="buyer-card__label">Workforce &amp; Capability Planning</span>'));
assert(homepage.includes('href="compliance-intelligence.html"'));
assert(homepage.includes('href="organization-intelligence.html"'));
assert(homepage.includes('href="workforce-capability-planning.html"'));
