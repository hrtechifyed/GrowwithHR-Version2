"use strict";
const base=require("./server-legal-explanation-router-wave4a.js");
const {buildAllLawsPrivateBetaRegistry}=require("./server-all-laws-private-beta-wave4b.js");
const {createRunnableAllLawsFeatureSpecifications}=require("./server-all-laws-rule-catalogs-wave4b.js");
const {loadGovernedLegalCatalogs}=require("./server-legal-rag-catalogs.js");
const SHARED_ROUTER_VERSION="1.8.0";
...
function statusPayload(registry,catalogSnapshot,retrievalMode){return Object.freeze({...base.statusPayload(registry,catalogSnapshot,retrievalMode),routerVersion:SHARED_ROUTER_VERSION,limitations:[
 "Seven POSH, ten Maternity Benefit, twelve EPF/EPS/EDLI and ten ESI Wave 4A–4B profiles use feature-specific deterministic rules and governed catalogues.",
 "Waves 1–4B remain needs-legal-review and emit specialist-review or more-information-needed, not legal certification, ESI applicability, threshold or rate selection, contribution calculations or individual insurance decisions.",
 "Eighteen remaining profiles are runnable through conservative governance-fallback catalogues.",
 "Wave 4B processes organisation-level source-readiness, routing and escalation controls plus evidence references only.",
 "Retrieval and provider output cannot supply missing notifications, create facts, infer personal data, select thresholds or rates, calculate amounts or alter deterministic outcomes."
 ]});}
