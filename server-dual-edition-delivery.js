...
function customerMessage(lead = {}, report = {}, filenames = []) {
    ...
    const text = [
        ...
        "",
        "Both attachments contain the same assessment findings. The Light and Dark editions differ only in visual presentation.",
        "",
    ...
    try {
        ...
        if (action !== "resend-customer" && internalRecipient) {
            if (!isValidEmail(internalRecipient)) {
                ...
                try {
                    const notice = internalMessage(lead, report, answers);
