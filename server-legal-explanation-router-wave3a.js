...
const base = require("./server-legal-explanation-router.js");
const {
    buildAllLawsPrivateBetaRegistry
} = require("./server-all-laws-private-beta-wave3a.js");
const {
    createRunnableAllLawsFeatureSpecifications
} = require("./server-all-laws-rule-catalogs-wave3a.js");
const {
...
function statusPayload(registry, catalogSnapshot, retrievalMode) {
    return Object.freeze({
        ...
        limitations: [
            ...
            "Wave 1, Wave 2 and Wave 3A reviews remain needs-legal-review and emit specialist-review or more-information-needed, not legal certification, payroll calculations or individual membership decisions.",
            "Thirty-five remaining profiles are runnable through conservative governance-fallback catalogues.",
...
function createSharedLegalExplanationRequestHandler(options = {}) {
    ...
    return function handleWave3aLegalExplanationRequest(request, response) {
